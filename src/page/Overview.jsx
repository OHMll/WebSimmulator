...
function Overview() {
    ...
    return (
        <div className="bg-[#3F72AF] min-h-[calc(100vh-6.77rem)] w-full overflow-hidden relative ">
            <div className="flex flex-col items-center px-4 py-6  ">
                <div className="pt-8  grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-7xl">
                    {topics.map((topic) => (
                        <div
                            key={topic.id}
                        ...
                        >
                            ...
                            <div
                                className="rounded-lg w-3/4 flex justify-center items-center py-3 "
